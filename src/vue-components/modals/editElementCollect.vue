        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <input
                    ...
                    min="50"
                    max="100"
                    :disabled="!gridElement.showLabels || !autoOrSeparatedMode"
                    v-model.number="gridElement.imageHeightPercentage"
                />
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-4">
                <input
                    v-if="gridElement"
                    class="col-12"
                    id="singleTextElemFactor"
                    type="number"
                    min="0"
                    max="5"
                    step="0.1"
                    :disabled="!autoOrSeparatedMode"
                    v-model.number="gridElement.textElemSizeFactor"
                />
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <input
                    ...
                    id="showLabel"
                    type="checkbox"
                    v-model="gridElement.showLabels"
                    :disabled="!autoOrSeparatedMode"
                />
        ...
        <div class="row">
            <div class="col-12">
                <input
                    ...
                    id="useSingleLine"
                    type="checkbox"
                    v-model="gridElement.singleLine"
                    :disabled="!autoOrSeparatedMode"
                />
        ...
        <div class="row">
            <div class="col-12">
                <input
                    ...
                    type="checkbox"
                    v-model="gridElement.convertToLowercase"
                />
        ...
        <div class="row">
            <div class="col-12">
                <input
                    ...
                    id="ipaPronunciation"
                    type="checkbox"
                    v-model="gridElement.ipaPronunciation"
                />
                <label for="ipaPronunciation">{{ $t('sendIpaPronunciationToTts') }}</label>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    computed: {
        autoOrSeparatedMode: function () {
            return [GridElementCollect.MODE_AUTO, GridElementCollect.MODE_COLLECT_SEPARATED].includes(
                this.gridElement.mode
            );
        }
    },
    methods: {},
